    ...
    return (
        <Faq>
            ...
            <div className="flex flex-col gap-3 divide-y">
                <FaqAccordion containerRef={containerRef} id={1} header="Lorem ipsum dolor sit amet consectetur adipisicing?" expanded={expand} onExpandedChange={() => setExpand(!expand)}>
